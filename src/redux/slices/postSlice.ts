...
const initialState: IPost[] = [
	{
		id: 1,
		content: 'What a cool site. Just missing some friends!',
		created: 1604322329404,
		added_by: 1,
		likes: [],
	},
	...
	{ id: 4, content: 'Daniel is so cool', created: 1655179597085, added_by: 3, likes: [] },
	{
		id: 5,
		content:
			"On a Pokemon's profile page, you can click the image to see the official shiny artwork..!!",
...
const postSlice = createSlice({
	...
	reducers: {
		...
		post_LIKE(
			state,
			action: PayloadAction<{ postId: number | string; userId: number | string }>,
		) {
